  ...
  <div class="pencarian-cuX">
    <div class="auto-group-rfyd-3V3">
      ...
      <div class="search-section-bkm">
        <img class="icon-5A9" src="./assets/icon.png" />
      ...
      <div class="auto-group-jbvb-5Sy">
        <img class="vector-CGh" src="./assets/vector.png" />
        <div class="result-section-j1j">
          <div class="auto-group-dq7m-QtZ">
            <img class="clock-w7o" src="./assets/clock.png" />
            <p class="universitas-f3o">Universitas</p>
          </div>

          <div class="auto-group-28jf-VS9">
            <img class="clock-pUR" src="./assets/clock-wX7.png" />
          ...
          <div class="auto-group-gtrk-ZD3">
            <img class="clock-Uqo" src="./assets/clock-ACZ.png" />
